    ...
    <div className="flex items-center justify-between py-5 font-medium relative">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="group relative">
          ...
          {/*dropdown menu */}
          {token && (
            <div className="absolute right-0 mt-2 w-36 bg-white shadow-lg rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-50">
      ...
      <div
        className={` fixed top-0 right-0 bottom-0 overflow-hidden bg-black  z-50    transition-all ${
          visible ? "w-500 py-0" : "w-0"
        } `}
      >
