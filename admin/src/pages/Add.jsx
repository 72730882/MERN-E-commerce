...
// converting the fields into controlled input field
  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex flex-col w-full items-start gap-3 ">
        ...
        <div className="w-full">
            ...
            <input onChange={(e)=>setName(e.target.value)} value={name} className="w-full ma-w-[500px] px-3 py-2" type="text" placeholder="  Type here" required/>
         </div>
         <div className="w-full">
            <p className="mb-2 font-bold">Product description</p>
            <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className="w-full ma-w-[500px] px-3 py-2" type="text" placeholder="Write content here" required/>
         </div>
         ...
         <button type="submit" className="w-28 p-3 mt-4 bg-black text-white">ADD</button>
    </form>
  )
}
